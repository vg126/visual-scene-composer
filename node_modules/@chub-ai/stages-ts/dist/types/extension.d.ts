 ...
 ***/
export declare abstract class Extension<InitStateType, ChatStateType, MessageStateType, ConfigType> extends StageBase<InitStateType, ChatStateType, MessageStateType, ConfigType> {
}
